			...
			public function do_user_directory() {
				...
				foreach ( $users as $user ) { ?>
					<div class="directory_item">
						<h3><a href="profile-view.php?uid=<?php echo $user->ID; ?>"><?php echo $user->user_name; ?></a></h3>
			...
			public function do_inbox($user_id) {
				...
				foreach ( $message_objects as $message ) {?>
					<div class="status_item">
						...
						<h3>From: <a href="profile-view.php?uid=<?php echo $user->ID; ?>"><?php echo $user->user_name; ?></a></h3>
